...
class ResearchesTest < ApplicationSystemTestCase
  ...
  test "creating a Research" do
    ...
    fill_in "Chn research check", with: @research.chn_research_check
    ...
    fill_in "Jpn research check", with: @research.jpn_research_check
    fill_in "Simulate price", with: @research.simulate_price
    fill_in "Team", with: @research.team_id
